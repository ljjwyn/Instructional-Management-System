<template>
  <el-row>
    <el-col :span="24">
      <div id="rbtop1" style="width: 600px;height: 100px;" />
    </el-col>
...
export default {
  ...
  methods: {
    buildPlot() {
      ...
      const myChart = echarts.init(document.getElementById('rbtop1'))
      // 指定图表的配置项和数据
      const option = {
        title: [{
          text: '2019级教师人数统计',
        ...
        tooltip: {
          ...
          formatter: '老师人数<br />{a0}: {c0}人<br />{a1}: {c1}人<br />'
        },
        // 图例组件
        ...
        series: [
          {
            type: 'bar', // 系列类型
            name: '男老师', // 系列名称, 用于tooltip的显示, legend 的图例筛选
          ...
          {
            type: 'bar', // 系列类型
            name: '女老师', // 系列名称, 用于tooltip的显示, legend 的图例筛选
            // 数据堆叠，同个类目轴上系列配置相同的stack值后，后一个系列的值会在前一个系列的值上相加
            stack: '总量',
            itemStyle: {
              color: '#f6de08', // 设置柱子颜色
